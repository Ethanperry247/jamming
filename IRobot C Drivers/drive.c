  ...
  for(;;)
  {
    ...
    if(UserButtonPressed)
    {
        ...
        )
      {
        ...
        else if(sensors[SenBumpDrop] & BumpEither & sensors[SenVWall])  // Check for a bump
        {
        ...
        {
          // Otherwise, choose one among 4 different options and do.
          // Move forward, backward, turn CW or CCW
          int choice = randomSelection(); 
...
// Initializ ethe Mind Control's ATmega168 microcontroller
void initialize(void)
{
  cli();
